...
import io.github.joacirsoares.vendasapi.model.repository.ClienteRepository;

@RestController
@RequestMapping("/api/clientes")
@CrossOrigin("*") /* Serve para que a aplicação next obtenha acesso a api*/
public class ClienteController {
	...
	/* Utilizando programação funcional do java no GetMapping */
	@GetMapping("{id}")
	...
	/* Utilizando programação funcional do java no DeleteMapping */
	@DeleteMapping("{id}")
